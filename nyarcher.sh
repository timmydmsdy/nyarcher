...
install_extensions () {
  ...
  svn checkout https://github.com/NyarchLinux/NyarchLinux/tree/main/Gnome/etc/skel/.local/share/gnome-shell/extensions
...
configure_neofetch() {
  ...
  cd ~/.config
  svn checkout https://github.com/NyarchLinux/NyarchLinux/tree/main/Gnome/etc/skel/.config/neofetch
}

download_wallpapers() {
  cd /tmp
  svn checkout https://github.com/NyarchLinux/NyarchLinux/tree/main/Gnome/etc/skel/.local/share/backgrounds
...
download_icons() {
  ...
  svn checkout https://github.com/NyarchLinux/NyarchLinux/tree/main/Gnome/etc/skel/.local/share/icons
}

set_themes() {
  cd ~/.local/share
  mv themes themes-backup  # Backup icons
  svn checkout https://github.com/NyarchLinux/NyarchLinux/tree/main/Gnome/etc/skel/.local/share/themes
  cd ~/.config
  # Set GTK4 and GTK3 themes
  mv gtk-3.0 gtk-3.0-backup
  mv gtk-4.0 gtk-4.0-backup
  svn checkout https://github.com/NyarchLinux/NyarchLinux/tree/main/Gnome/etc/skel/.config/gtk-3.0
  svn checkout https://github.com/NyarchLinux/NyarchLinux/tree/main/Gnome/etc/skel/.config/gtk-4.0
}
